package cn.tianyu.client.viamcp.utils;
...
public class AttackOrder
{
    ...
    {
        // Using this instead of cn.tianyu.client.viamcp.PROTOCOL_VERSION so does not need to be changed between 1.8.x and 1.12.2 base
