package cn.tianyu.client.viamcp.gui;
...
import cn.tianyu.client.viamcp.protocols.ProtocolCollection;
...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    class SlotList extends GuiSlot
    {
        ...
        protected void elementClicked(int i, boolean b, int i1, int i2)
        {
            ...
            cn.tianyu.client.viamcp.ViaMCP.getInstance().setVersion(protocolVersion);
            cn.tianyu.client.viamcp.ViaMCP.getInstance().asyncSlider.setVersion(protocolVersion);
        }
