...
import cn.tianyu.client.viamcp.utils.FutureTaskId;
...
public class MCPViaPlatform implements ViaPlatform<UUID>
{
    ...
    {
        return new FutureTaskId(CompletableFuture.runAsync(runnable, cn.tianyu.client.viamcp.ViaMCP.getInstance().getAsyncExecutor()).exceptionally(throwable ->
        {
