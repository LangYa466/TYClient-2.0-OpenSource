...
public class RenderUtil {
    public static void renderLabel(Entity entityIn, String str, int maxDistance, float partialTicks) {
        ...
        double d0 = entityIn.getDistanceSqToEntity(Minecraft.thePlayer);
    ...
    public void image(ResourceLocation imageLocation, double x, double y, double width, double height) {
        this.image(imageLocation, (float)x, (float)y, (float)width, (float)height);
    }
}
