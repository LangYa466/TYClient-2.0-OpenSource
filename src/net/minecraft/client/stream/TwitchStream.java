...
IStream {
                ...
                public void run() {
                    try {
                        ...
                        if (JsonUtils.getBoolean(jsonobject1, "valid")) {
                            ...
                            LOGGER.debug(STREAM_MARKER, "Authenticated with twitch; username is {}", s1);
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        ...
        this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText("Issue streaming frame: " + (Object)((Object)p_152893_1_) + " (" + ErrorCode.getString(p_152893_1_) + ")"), 2);
    }
    ...
    public void func_152892_c(ErrorCode p_152892_1_) {
        if (p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
            ...
            ChatComponentTranslation ichatcomponent2 = new ChatComponentTranslation("stream.unavailable.unknown.chat", ErrorCode.getString(p_152892_1_));
