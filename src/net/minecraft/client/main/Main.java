...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("TYClient", (String[])new String[0]);
        ...
        Runtime.getRuntime().addShutdownHook(new Thread("TYClient Shutdown Thread"){
        ...
        Thread.currentThread().setName("TYClient thread");
