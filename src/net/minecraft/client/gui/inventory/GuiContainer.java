...
extends GuiScreen {
    ...
    private void drawSlot(Slot slotIn) {
        ...
        ItemStack itemstack1 = Minecraft.thePlayer.inventory.getItemStack();
        String s = null;
            ...
            if (GuiContainer.isShiftKeyDown()) {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        ...
                        if (!slot2.canTakeStack(Minecraft.thePlayer) || !slot2.getHasStack() || slot2.inventory != slot.inventory || !Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) continue;
    ...
    public void updateScreen() {
        block3: {
            block2: {
                super.updateScreen();
                if (!Minecraft.thePlayer.isEntityAlive()) break block2;
                if (!Minecraft.thePlayer.isDead) break block3;
            }
            Minecraft.thePlayer.closeScreen();
        }
    }
