...
implements GuiYesNoCallback {
        ...
        if (button.enabled) {
            if (button.id == 2) {
                ...
                if (s != null) {
                    ...
                    GuiYesNo guiyesno = GuiSelectWorld.func_152129_a(this, s, this.field_146640_r);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146628_f, this.width / 2, 20, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            ((GuiSelectWorld)GuiSelectWorld.this).selectButton.enabled = flag = GuiSelectWorld.this.field_146640_r >= 0 && GuiSelectWorld.this.field_146640_r < this.getSize();
