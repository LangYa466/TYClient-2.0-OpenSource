...
extends GuiScreen {
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
        ...
        f3 *= f3;
        f3 = f3 * 96.0f / 255.0f;
        worldrenderer.pos(0.0, this.height, this.zLevel).tex(0.0, f * f2).color(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(i, this.height, this.zLevel).tex((float)i * f2, f * f2).color(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(i, 0.0, this.zLevel).tex((float)i * f2, f1 * f2).color(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(0.0, 0.0, this.zLevel).tex(0.0, f1 * f2).color(f3, f3, f3, 1.0f).endVertex();
        tessellator.draw();
    }
