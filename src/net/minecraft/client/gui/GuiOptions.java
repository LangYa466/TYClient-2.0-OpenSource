...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options gamesettings$options : GuiOptions.field_146440_f) {
        ...
        Label_0452: {
            if (Minecraft.theWorld != null) {
                ...
                final EnumDifficulty enumdifficulty = Minecraft.theWorld.getDifficulty();
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 109) {
                ...
                final String translationKey = "difficulty.lock.question";
                final Object[] args = { null };
                final int n = 0;
                final Minecraft mc5 = this.mc;
                args[n] = new ChatComponentTranslation(Minecraft.theWorld.getWorldInfo().getDifficulty().getDifficultyResourceKey(), new Object[0]);
                mc4.displayGuiScreen(new GuiYesNo(this, formattedText, new ChatComponentTranslation(translationKey, args).getFormattedText(), 109));
            }
            if (button.id == 110) {
