...
public class ItemRenderer {
    ...
    private float getSwingProgress(float partialTicks) {
        ...
        float swingProgress = (float)Minecraft.thePlayer.getItemInUseDuration() - partialTicks;
        if (swingProgress < 0.0f) {
            swingProgress = 0.0f;
        }
        swingProgress /= 20.0f;
        swingProgress = MathHelper.sin(swingProgress * (float)Math.PI * 2.0f) * 0.1f;
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        EntityPlayerSP abstractclientplayer = Minecraft.thePlayer;
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() == Items.filled_map) {
                ...
                switch (enumaction) {
                    ...
                    case BLOCK: {
                        this.transformFirstPersonItem(swingProgress / 5.0f, swingProgress);
                        GlStateManager.translate(0.0, 0.2, 0.0);
                        GlStateManager.rotate(-var15, 4.0f, -0.8f, -1.0f);
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (Minecraft.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                IBlockState iblockstate1 = Minecraft.theWorld.getBlockState(blockpos);
    ...
    private void renderWaterOverlayTexture(float p_78448_1_) {
        ...
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        float f = Minecraft.thePlayer.getBrightness(p_78448_1_);
