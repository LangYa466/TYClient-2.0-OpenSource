...
extends Render<EntityItem> {
    ...
    private void physicsRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        rotation = (double)(System.nanoTime() - tick) / 5.0E13;
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (TYClient.modManager.getByClass(ItemPhysics.class).isEnable()) {
            this.physicsRender(entity, x, y, z, entityYaw, partialTicks);
        } else {
            this.vanillaRender(entity, x, y, z, entityYaw, partialTicks);
        }
    }
