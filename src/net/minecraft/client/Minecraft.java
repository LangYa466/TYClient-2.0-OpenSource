...
import cn.tianyu.client.viamcp.utils.AttackOrder;
...
import cn.tianyu.client.gui.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new SplashScreen(), this, this.serverName, this.serverPort));
        }
        else {
    ...
    private void initStream() {
        try {
            this.stream = new TwitchStream(this, Iterables.getFirst((Iterable<? extends Property>)(this.twitchDetails).get("twitch_access_token"), (Property)null));
        }
        catch (final Throwable throwable) {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        final TYClient instance = TYClient.instance;
        Display.setTitle(sb.append("TYClient").append(" Loading... ").toString());
        try {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.getClass().getResourceAsStream("/assets/minecraft/client/icon/16.png");
                inputstream2 = this.getClass().getResourceAsStream("/assets/minecraft/client/icon/32.png");
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            this.fontRendererObj.drawStringWithShadow(s = decimalformat.format(profiler$result.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s)), (float)(k - i / 2 - 16), l3);
            for (int k3 = 0; k3 < list.size(); ++k3) {
                ...
                s2 += profiler$result3.field_76331_c;
                this.fontRendererObj.drawStringWithShadow(s2, (float)(j - i), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s2 = decimalformat.format(profiler$result3.field_76332_a) + "%", (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s2 = decimalformat.format(profiler$result3.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.func_76329_a());
            }
        }
    }
    ...
    private void sendClickBlockToController(final boolean leftClick) {
        ...
        if (this.leftClickCounter <= 0) {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (Minecraft.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit)) {
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY: {
                        AttackOrder.sendFixedAttack(Minecraft.thePlayer, this.objectMouseOver.entityHit);
                        return;
                    }
                    case BLOCK: {
                        final BlockPos blockpos = this.objectMouseOver.getBlockPos();
                        if (Minecraft.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air) {
    ...
    public void rightClickMouse() {
        if (!this.playerController.func_181040_m()) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    case BLOCK: {
                        ...
                        if (this.playerController.onPlayerRightClick(Minecraft.thePlayer, Minecraft.theWorld, itemstack, blockpos, this.objectMouseOver.sideHit, this.objectMouseOver.hitVec)) {
                            flag = false;
                            Minecraft.thePlayer.swingItem();
                        }
                        if (itemstack == null) {
            ...
            if (flag) {
                ...
                if (itemstack2 != null && this.playerController.sendUseItem(Minecraft.thePlayer, Minecraft.theWorld, itemstack2)) {
    ...
    public void runTick() throws IOException {
        if (Minecraft.thePlayer != null && !CustomLoginScreen.ClientLogin) {
            TYClient.stop();
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    final TYClient instance = TYClient.instance;
                    TYClient.modManager.getEnableMods().forEach(mod -> mod.key(k));
                    final TYClient instance2 = TYClient.instance;
                    TYClient.modManager.onKey(k);
            ...
            if (!this.isGamePaused) {
                ...
                try {
                    ...
                    if (Minecraft.theWorld == null) {
                        ...
                        Minecraft.theWorld.addWorldInfoToCrashReport(crashreport3);
                    }
    ...
    public void loadWorld(final WorldClient worldClientIn, final String loadingMessage) {
        ...
        if ((Minecraft.theWorld = worldClientIn) != null) {
            if (this.renderGlobal != null) {
    ...
    public void setDimensionAndSpawnPlayer(final int dimension) {
        ...
        Minecraft.thePlayer = this.playerController.func_178892_a(Minecraft.theWorld, (Minecraft.thePlayer == null) ? new StatFileWriter() : Minecraft.thePlayer.getStatFileWriter());
    ...
    private void middleClickMouse() {
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                item = block.getItem(Minecraft.theWorld, blockpos);
                if (item == null) {
                    return;
                }
                if (flag && GuiScreen.isCtrlKeyDown()) {
                    tileentity = Minecraft.theWorld.getTileEntity(blockpos);
                }
                final Block block2 = (item instanceof ItemBlock && !block.isFlowerPot()) ? Block.getBlockFromItem(item) : block;
                i = block2.getDamageValue(Minecraft.theWorld, blockpos);
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(final CrashReport theCrash) {
        ...
        theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>() {
            ...
            public String call() throws Exception {
                ...
                return s.equals("vanilla") ? ((Minecraft.class.getSigners() == null) ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and client brand is untouched.") : ("Definitely; TYClient brand changed to '" + s + "'");
            }
        });
        theCrash.getCategory().addCrashSectionCallable("Type", new Callable<String>() {
            @Override
            public String call() throws Exception {
                return "TYClient (map_client.txt)";
            }
        });
    ...
    static {
        ...
        locationMojangPng = new ResourceLocation("font/font/CN_tianyu.png");
