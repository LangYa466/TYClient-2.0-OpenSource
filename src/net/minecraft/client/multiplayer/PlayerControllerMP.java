...
public class PlayerControllerMP {
    ...
    public static void clickBlockCreative(Minecraft mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_, EnumFacing p_178891_3_) {
        if (!Minecraft.theWorld.extinguishFire(Minecraft.thePlayer, p_178891_2_, p_178891_3_)) {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (this.currentGameType.isCreative()) {
            if (Minecraft.theWorld.getWorldBorder().contains(posBlock) && block.getMaterial() != Material.air) {
                this.blockHitDelay = 5;
    ...
    public boolean isBreakingBlock() {
        ...
        if (!Minecraft.thePlayer.capabilities.allowEdit) return false;
