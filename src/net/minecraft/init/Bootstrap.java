    ...
    static void registerDispenserBehaviors() {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.bucket, new BehaviorDefaultDispenseItem(){
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                ...
                BlockPos blockpos;
                World world = source.getWorld();
                IBlockState iblockstate = world.getBlockState(blockpos = source.getBlockPos().offset(BlockDispenser.getFacing(source.getBlockMetadata())));
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.flint_and_steel, new BehaviorDefaultDispenseItem(){
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                BlockPos blockpos;
                World world = source.getWorld();
                if (world.isAirBlock(blockpos = source.getBlockPos().offset(BlockDispenser.getFacing(source.getBlockMetadata())))) {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.dye, new BehaviorDefaultDispenseItem(){
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
                if (EnumDyeColor.WHITE == EnumDyeColor.byDyeDamage(stack.getMetadata())) {
                    BlockPos blockpos;
                    World world = source.getWorld();
                    if (ItemDye.applyBonemeal(stack, world, blockpos = source.getBlockPos().offset(BlockDispenser.getFacing(source.getBlockMetadata())))) {
                        if (!world.isRemote) {
