...
public class BlockFarmland extends Block
{
    ...
    public void updateTick(final World worldIn, final BlockPos pos, final IBlockState state, final Random rand) {
        ...
        if (!this.hasWater(worldIn, pos) && !worldIn.canLightningStrike(pos.up())) {
            if (i > 0) {
                worldIn.setBlockState(pos, state.withProperty(BlockFarmland.MOISTURE, i - 1), 2);
            }
            ...
            worldIn.setBlockState(pos, state.withProperty(BlockFarmland.MOISTURE, 7), 2);
        }
    }
    ...
    public IBlockState getStateFromMeta(final int meta) {
        return this.getDefaultState().withProperty(BlockFarmland.MOISTURE, meta & 0x7);
    }
