    ...
    protected void updateAITasks() {
        if (this.getInvulTime() > 0) {
            ...
            block0: for (int i = 1; i < 3; ++i) {
                ...
                List<Entity> list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0, 8.0, 20.0), Predicates.and(attackEntitySelector, EntitySelectors.NOT_SPECTATING));
