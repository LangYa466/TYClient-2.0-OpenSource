...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EnumStatus trySleep(final BlockPos bedLocation) {
        if (!this.worldObj.isRemote) {
            ...
            final double d0 = 8.0;
            final double d2 = 5.0;
            final List<EntityMob> list = this.worldObj.getEntitiesWithinAABB(EntityMob.class, new AxisAlignedBB(bedLocation.getX() - d0, bedLocation.getY() - d2, bedLocation.getZ() - d0, bedLocation.getX() + d0, bedLocation.getY() + d2, bedLocation.getZ() + d0));
            if (!list.isEmpty()) {
